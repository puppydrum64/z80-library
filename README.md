...
These files use the terms "Game Boy," "Gameboy," and "Game Boy Color" interchangeably unless otherwise noted. Both the Game Boy and the Game Boy Color have the same instruction set.

"Game Boy" is a trademark of Nintendo. No Game Boy games or Game Boy ROMs were disassembled to create these files. All files in this commit were created using techniques learned from publicly known documentation, found on free online resources. 
